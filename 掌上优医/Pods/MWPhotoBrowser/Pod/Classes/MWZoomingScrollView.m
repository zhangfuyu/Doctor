...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
        ...
        [_photoImageView addGestureRecognizer:longPressGR];
...
- (void)longPressAction:(UIGestureRecognizer *)gr {
    ...
    UIAlertAction *saveAction = [UIAlertAction actionWithTitle:@"保存到相册" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        MWTapDetectingImageView *imageView = (MWTapDetectingImageView *)gr.view;
    ...
    [_photoBrowser presentViewController:alert animated:true completion:nil];
