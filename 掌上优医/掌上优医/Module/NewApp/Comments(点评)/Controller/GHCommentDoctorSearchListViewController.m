//
//  GHCommentDoctorSearchListViewController.m
//  掌上优医
//
...
@interface GHCommentDoctorSearchListViewController ()<UITableViewDelegate, UITableViewDataSource, GHProvinceCityAreaViewControllerDelegate, GHDoctorSortViewControllerDelegate, GHDoctorFilterViewControllerDelegate>
...
@implementation GHCommentDoctorSearchListViewController
...
//    params[@"areaLevel"] = @(self.doctorAreaLevel);
    ...
    [[GHNetworkTool shareInstance] requestWithMethod:GHRequestMethod_GET withUrl:kApiSearchDoctor withParameter:params withLoadingType:GHLoadingType_ShowLoading withShouldHaveToken:YES withContentType:GHContentType_Formdata completionBlock:^(BOOL isSuccess, NSString * _Nonnull msg, id  _Nonnull response) {
        ...
        if (isSuccess) {
            ...
            for (NSDictionary *dicInfo in hospitalDoctorList) {
...
- (void)setupNavigationBar {
    ...
    searchTextField.placeholder = @"搜索医生姓名";
