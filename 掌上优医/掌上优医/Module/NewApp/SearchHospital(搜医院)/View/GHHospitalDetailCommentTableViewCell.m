//
//  GHHospitalDetailCommentTableViewCell.m
//  掌上优医
//
...
@interface GHHospitalDetailCommentTableViewCell ()
...
@implementation GHHospitalDetailCommentTableViewCell
...
//    [self.backgroundStarView mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.height.mas_equalTo(22);
//        make.left.mas_equalTo(SCREENWIDTH - 135);
//        make.width.mas_equalTo(15 * 5);
//        make.centerY.mas_equalTo(scoreValueLabel);
//    }];
//
...
- (void)setModel:(GHDoctorCommentModel *)model {
    ...
    self.timeLabel.text = model.createTime;//[[NSDate dateWithString:ISNIL(model.createTime) format:@"yyyy-MM-dd HH:mm:ss"] stringWithFormat:@"yyyy年MM月dd日"];
...
//    self.foregroundStarView.width = (13.5 * .5 * [model.score integerValue]);
