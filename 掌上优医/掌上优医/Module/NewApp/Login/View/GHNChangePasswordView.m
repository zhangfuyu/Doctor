...
@interface GHNChangePasswordView ()
...
@implementation GHNChangePasswordView
...
- (void)setupUI {
    ...
    phoneTextField.text = ISNIL([GHUserModelTool shareInstance].account);
...
//    phoneTextField.leftViewMode = UITextFieldViewModeAlways;
    ...
    passwordTitleLabel.font = H15;
    passwordTitleLabel.textColor = kDefaultGrayTextColor;
    ...
    [passwordTitleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(-34);
        make.height.mas_equalTo(HScaleHeight(37));
        make.top.mas_equalTo(verifyCodeTextField.mas_bottom).offset(12);
    }];
    
    GHTextField *passwordTextField = [[GHTextField alloc] init];
    passwordTextField.font = HScaleFont(15);
    passwordTextField.textColor = kDefaultBlackTextColor;
    passwordTextField.placeholder = @"请输入您的新密码";
    passwordTextField.backgroundColor = UIColorHex(0xF5F5F5);
    passwordTextField.layer.cornerRadius = HScaleHeight(25);
    passwordTextField.layer.masksToBounds = true;
    passwordTextField.returnKeyType = UIReturnKeyDone;
    passwordTextField.keyboardType = UIKeyboardTypeASCIICapable;
    [passwordTextField setSecureTextEntry:true];
    passwordTextField.rightSpace = HScaleHeight(29);
    passwordTextField.leftSpace = HScaleHeight(29);
    ...
    [passwordTextField mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(-34);
        make.height.mas_equalTo(HScaleHeight(50));
        make.top.mas_equalTo(passwordTitleLabel.mas_bottom);
    }];
    ...
    [loginButton setTitle:@"确 定" forState:UIControlStateNormal];
    ...
    [loginButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(-34);
        make.height.mas_equalTo(HScaleHeight(50));
        make.top.mas_equalTo(passwordTextField.mas_bottom).offset(47);
    }];
...
- (void)clickGetVerifyAction {
    ...
    if ([self.delegate respondsToSelector:@selector(changePasswordViewClickGetVerifyAction)]) {
        [self.delegate changePasswordViewClickGetVerifyAction];
    }
...
- (void)clickLoginAction {
    ...
    if ([self.delegate respondsToSelector:@selector(changePasswordViewClickLoginAction)]) {
        [self.delegate changePasswordViewClickLoginAction];
    }
