...
@interface GHZuJiSicknessTableViewCell ()
...
@implementation GHZuJiSicknessTableViewCell
...
- (void)setModel:(GHZuJiSicknessModel *)model {
    
    _model = model;
    
    self.nameLabel.text = ISNIL(model.diseaseName);
    self.descLabel.text = ISNIL(model.symptom);
