...
@protocol GHSegmentTitleViewDelegate <NSObject>
...
@interface GHSegmentTitleView : UIView
@property (nonatomic, weak) id<GHSegmentTitleViewDelegate>delegate;
